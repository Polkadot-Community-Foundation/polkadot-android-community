...
The core generates part of its Rust sources at build time from rustdoc JSON, which needs a nightly toolchain: `rustup toolchain install nightly --profile minimal` once. Gradle runs the codegen itself.
